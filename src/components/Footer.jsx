...
function Footer() {
  const [footerData] = useState({
    ...
    contactDetails: [
      { type: "Email", value: "ravi@gmail.com" },
      { type: "Phone", value: "+91 7014521598" },
      { type: "Address", value: "Main Street, City, Country" },
    ],
    importantLinks: [
      { label: "GitHub", url: "https://ravigithub.com" },
      { label: "LinkedIn", url: "https://linkedin.com/in/ravi" },
      { label: "Portfolio", url: "https://ravi.dev" },
    ],
    bottomLinks: [
